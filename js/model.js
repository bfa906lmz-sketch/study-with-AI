...
export const state = {
  ...
  hubContent: { "Group Chat": ["Team B: vector direction is confusing."], "Private Chat": ["Ava → Teacher: can you revisit region A?"], "Hand Raises": ["Noah: annotate the equation?"], Polls: ["Poll #1: Which quantity stays constant?"], Requests: ["Emma: show more screen examples"] },
